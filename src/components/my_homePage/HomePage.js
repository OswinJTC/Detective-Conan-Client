...
const HomePage = ({ movies }) => {
  return (
    ...
    <div className="below-carousel-container container-fluid  border mb-5 mt-5">
        ...
        <div className='col-md-1 border'></div>
            ...
            <div className="col-md-5 text-center border d-flex flex-column align-items-center justify-content-center">
              <h1><b>超強網站功能</b></h1>
              <h2>不逛一下，保證你會後悔</h2>
              <h1></h1>
            ...
            <div className="col-md-4 border d-flex flex-column justify-content-center">
    ...
    <div className="three-photo-showing container border mt-5">
        ...
        <div className="row">
            ...
            <div className="col-md-4 text-center border py-3">
            <h2>hahaha</h2>
            </div>
    ...
    <div className="below-banner-container container rounded-5 border mb-5 mt-5">
        ...
        <div className="row">
            ...
            <div className="col-md-6 border d-flex align-items-center justify-content-center">
                 ...
                 <h5>嚴選天然食材，精湛匠心烘培，讓幸福在每口麵包中的香氣中蔓延</h5>
